...
namespace Shopping.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Login()//Va logear
        {
            if (User.Identity.IsAuthenticated)//valida si esta logeado
            {
                return RedirectToAction("Index", "Home");
            }

            return View(new LoginViewModel());//se va a logear
        }
        ...
        public async Task<IActionResult> Logout()//Va a desbloquear el usuario
        {
